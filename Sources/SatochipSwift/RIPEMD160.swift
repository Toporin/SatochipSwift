// from https://stackoverflow.com/questions/43091858/swift-hash-a-string-using-hash-hmac-with-ripemd160/43193583#43193583
import Foundation
...
public extension RIPEMD160 {
    ...
    static func hash(message: [UInt8]) -> [UInt8] {
        var md = RIPEMD160()
        md.update(data: Data(message))
        return [UInt8](md.finalize())
    }
